...
def main(
    ...
    final_time: float = typer.Option(35.0, help="Final IVP integration time [years]."),
    ...
    settings = RunSettings(final_time=final_time * YEAR, time_output_count=time_output_count)
